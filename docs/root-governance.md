# Root Governance: Git-GitHub-Knowledge-Base

Dokumen ini memuat aturan tingkat root untuk monorepo **Git & GitHub Knowledge Base**.
...
- `.cursorrules`: Sebagai hukum interaksi AI khusus Version Control.
...
- Konvensi penomoran & AI Persona (Version Control & Collaboration Governance Expert).
